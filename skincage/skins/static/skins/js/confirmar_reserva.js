document.addEventListener("DOMContentLoaded", function () {
  ...
  const precioRecargoDisplay = document.getElementById(
    "precio-recargo-display",
  );
  ...
  const balance = parseFloat(
    userBalanceEl.getAttribute("data-balance").replace(",", "."),
  );
  ...
  function actualizarUI() {
    ...
    precioRecargoDisplay.textContent =
      "+" +
      recargo.toFixed(2) +
      " €" +
